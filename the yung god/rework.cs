...
namespace Cassiopeia
{
    class Program
    {
        ...
        static void OnGameLoad(EventArgs args)
        {
            ...
            Game.PrintChat("We testin shit nigga");
            ...
            menu.AddSubMenu(new Menu("Freeze", "Freeze"));
            menu.SubMenu("Freeze").AddItem(new MenuItem("qHarass", "Use Q").SetValue(false));
            menu.SubMenu("Freeze").AddItem(new MenuItem("lasthitE", "Last hit without poison").SetValue(true));
            ...
            menu.SubMenu("LaneClear").AddItem(new MenuItem("laneclearW", "Use W").SetValue(false));
            menu.SubMenu("LaneClear").AddItem(new MenuItem("onlylasthitE", "Only last hit E").SetValue(true));
        ...
        private static void lasthitE()
        {
            ...
            foreach (var minion in MinionList.Where(x => x.IsEnemy))
        ...
        private static void LineClear()
        {
            ...
            if (Q.IsReady() && menu.Item("laneclearQ").GetValue<bool>())
            {
